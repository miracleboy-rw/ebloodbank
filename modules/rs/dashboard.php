...
<!-- Emergency Banner -->
<div style="background:linear-gradient(135deg,#7c3aed,#5b21b6);border-radius:14px;padding:20px 24px;display:flex;align-items:center;justify-content:space-between;margin-bottom:20px;color:#fff">
  <div>
  ...
  <a href="/ebloodbank/index.php?page=rs_request&urgency=emergency" class="btn emergency-btn" style="background:#fff;color:#7c3aed;font-weight:700">
    🚨 Request Emergency
  </a>
</div>
